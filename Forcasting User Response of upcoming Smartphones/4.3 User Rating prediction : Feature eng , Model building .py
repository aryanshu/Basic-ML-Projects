...
def XGBoost_hyperparameters_tuning(x_train,y_train,x_test,y_test,n_estimators=[100, 200], max_depth=[ 10, 20 ,30 , 40] ):
...
if __name__ == '__main__':
	...
	print("Error in SPEC score "+abs(orig_df['rating']-orig_df['predict']).mean())
